...
## How to run
1. Download/Clone GroupDocs.Signature for Java Servlet Sample.
2. Extract/Copy GroupDocs.Signature for Java Servlet Sample to working directory.
3. Navigate to GroupDocs.Signature for Java Servlet Sample root directory.
4. Update parameters in `src/main/resources/configuration.properties` to meet your requirements.
5. Open console and type `cd 'GroupDocs.Signature for Java Servlet Sample root directory'`, press enter.
6. From console type following command: `mvn clean jetty:run`, press enter.
7. Go to `http://localhost:8080/signature/`.
